#!/usr/bin/env Rscript
# Turkish Chiefs of Staff - Interactive Choropleth Map with leaflet
...
cat("============================================================\n")
cat("Turkish Chiefs of Staff - Interactive Choropleth Map\n")
cat("============================================================\n\n")
...
provinces_with_commanders <- provinces_with_commanders %>%
  mutate(
    popup_text = sprintf(
      "<strong>%s</strong><br/>Country: %s<br/>Chiefs: %d<br/><small>%s</small>",
      province_match,
...
# Save the map
output_file <- "chiefs_birthplace_interactive.html"
