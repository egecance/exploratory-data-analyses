...
map <- leaflet(turkey) %>%
  ...
  addControl(
    html = "<div style='margin: 10px; background: white; padding: 15px; border-radius: 5px; max-width: 300px;'>
            <h3 style='margin: 0 0 10px 0;'>Turkish Officials' Birthplaces by Province</h3>
